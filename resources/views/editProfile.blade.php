...
<div class="card-header">
            @if(Auth::user()->avatar != '')
    <img src='public/images/avatar/{{Auth::user()->avatar }}' id='img-upload' class="rounded mx-auto d-block" alt="..." width="199" height="200"> @else
    <img src='public/images/avatar.png' id='img-upload' class="rounded mx-auto d-block" alt="..." width="199" height="200"> @endif
</div>
  <br />
  <br />
...
<input id="autocomplete" placeholder="Search address with City or State..." onFocus="geolocate()" type="text" class="form-control is-valid" name="autocomplete" style="background-color: rgba(66,133,244,0.67); color: #fff;" /> <br>
